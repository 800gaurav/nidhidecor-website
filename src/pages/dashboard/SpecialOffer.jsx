      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-12 border border-gray-100">
          ...
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-100">
            <button
             onClick={gotoPage}
            className="w-full bg-gradient-to-r from-[#0671FF] to-[#02D396] text-white py-3 px-6 rounded-lg font-medium hover:opacity-90 transition-opacity flex items-center justify-center">
              Start Investing Now
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={gotoPage} className="bg-gradient-to-r from-[#0671FF] to-[#02D396] text-white py-3 px-8 rounded-lg font-medium hover:opacity-90 transition-opacity">
              Buy now
            </button>
            <button onClick={gotoPage} className="border border-[#0671FF] text-[#0671FF] py-3 px-8 rounded-lg font-medium hover:bg-[#0671FF] hover:text-white transition-colors">
